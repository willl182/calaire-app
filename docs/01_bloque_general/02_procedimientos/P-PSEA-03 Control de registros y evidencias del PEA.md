...
7. La raiz de cada ronda debe permanecer limpia: solo contiene `checklist_ronda.md` y las carpetas de etapa controladas, incluida la etapa logica `02A_inicio_ronda`.
...
La raiz de la ronda solo contiene `checklist_ronda.md` y las carpetas de etapa controladas. `02A_inicio_ronda` conserva el acta `F-PSEA-19` firmada. La regla de archivo es simple: cada evidencia se conserva en la etapa que la genera o la usa principalmente. Las copias diligenciadas de formatos maestros se guardan en la carpeta de la ronda; los formatos maestros permanecen en `01_bloque_general/04_formatos_maestros/`.
...
| `F-PSEA-19` | Acta de inicio de ronda | `calaire-app` / coordinacion | Inicio presencial | Coordinacion del PEA | Registro oficial firmado | `P-PSEA-04`, `F-PSEA-03` |
| `F-PSEA-20` | Rotulado anonimo | Responsable tecnico | Preparacion e inicio | Responsable tecnico | Archivo interno | `P-PSEA-06`, `P-PSEA-19` |
| `F-PSEA-21` | Relacion de instrumentos Calaire usados | Responsable tecnico / `calaire-app` | Preparacion e inicio | Tecnico y coordinador | Registro nativo validado | `P-PSEA-06`, `P-PSEA-20` |
