...
6. Cargar `F-PSEA-20`, aplicar el rotulado anonimo y confirmar `usadoEnRonda`; toda sustitucion reinicia la confirmacion.
7. Diligenciar `F-PSEA-21` con minimo cuatro analizadores, un sistema de aire cero, un calibrador dinamico y un cilindro. Cada item debe incluir identificacion y dos fotos nuevas: vista general y placa/serial.
8. Someter `F-PSEA-21` a validacion del coordinador. Cualquier edicion posterior revoca la validacion y las exportaciones vigentes.
9. Generar o consolidar los datos necesarios para homogeneidad y estabilidad cuando aplique.
10. Entregar los registros al flujo digital y estadistico definido en `P-PSEA-08` y `P-PSEA-07`.
