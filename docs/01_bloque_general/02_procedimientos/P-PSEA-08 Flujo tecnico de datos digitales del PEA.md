...
7. Aplicar los controles del Anexo B de `I-PSEA-02`: conservar archivos originales, calcular promedios horarios, verificar cobertura minima del 75 %, registrar incertidumbre, unidades, factor `k`, nivel de confianza y archivo `F-PSEA-08`.
8. Clasificar CSV simples como evidencia oficial, soporte trazable, intermedio reproducible o transitorio.
