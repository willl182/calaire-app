...
| `F-PSEA-19` | Acta de inicio de ronda | Registro nativo exportable | Genera DOCX para firma manual; conserva y publica solo PDF firmado. | `P-PSEA-03`, `P-PSEA-04`, `F-PSEA-03`, `F-PSEA-21` |
| `F-PSEA-20` | Rotulado anonimo | Archivo interno | Controla archivo de rotulado y confirmacion `usadoEnRonda`; nunca se publica. | `P-PSEA-06`, `P-PSEA-19`, `F-PSEA-03` |
| `F-PSEA-21` | Relacion de instrumentos Calaire usados | Registro nativo exportable | Inventario interno con identificacion, dos fotos, revision, validacion y exportaciones PDF/XLSX. | `P-PSEA-06`, `P-PSEA-20`, `F-PSEA-19` |
