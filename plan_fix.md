...
- **F34 (Baja) — deuda aceptada.** Target 6 (consultas Convex acotadas/indexadas) se cierra por inventario y deuda documentada; no se introdujeron `.collect()` nuevos, pero quedan 215 en `convex/` como deuda de rendimiento explicita.
